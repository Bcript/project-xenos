...
<body>
  ...
  <div class="jumbotron" style="height: 100%; width: 100%; background-image: url('/assets/img/blur.png'); height: 100%; background-position: center; background-repeat: no-repeat; background-size: cover;background-color: transparent;">
    <div class="container text-center cont-1" style="margin-top: -30px; ">
      <br><br><br>
      <h1 class="h1" style="font-family: URW-Gothic-L; color: white;">Maintenance | project<b>Xenos</b></h3>
      <p class="f4" style="color: rgb(214, 214, 214);">an old ROBLOX private server designed to bring back 2012, 2014 and 2016</p>
      <h3 class="f4" style="color:rgb(214, 214, 214);">projectXenos is currently in maintenance, but you can visit our external links down below to never miss out on the fun!</h3>
    </div>
    <br/>
  <br>
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="Box">
          <div class="Box-header">
              <h2 class="Box-title" style="font-family: URW-Gothic-L; font-size: 18px;"><i class="fab fa-discord"></i><b> projectXenos</b> Discord</h2>
          </div>
          <div class="Box-body">
            <div class="card-body">
      ...
      <div class="col-sm-6">
        <div class="Box">
          <div class="Box-header">
              <h2 class="Box-title" style="font-family: URW-Gothic-L; font-size: 18px;"><i class="fab fa-twitter"></i><b> projectXenos</b> Twitter</h2>
          </div>
          <div class="Box-body">
            <div class="card-body">
  ...
  <br/>  <br><br>  <br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
    ...
    <footer class="footer" style="border-bottom-style: solid; border-width: 1px; border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; border-color: #dee0e1; border-top-color: rgb(222, 224, 225); border-right-color: rgb(222, 224, 225); border-bottom-color: rgb(222, 224, 225); border-left-color: rgb(222, 224, 225); box-shadow: 0 3px 6px rgba(0,0,0,0.04);">
      <div class="container">
        <span class="text-muted" style="font-family: URW-Gothic-L;">project<b>Xenos</b>(v2) by taskmanager, taxii and XlXi</span>
      </div>
    </footer>
